...
- pallet?
- rename this file to README.org so that GitHub displays as default (merge existing README.org into it)
...
#+BEGIN_SRC emacs-lisp
  (req-package guide-key
    ...
    :init
    (progn
      (setq guide-key/guide-key-sequence `("<SPC>" "g" "C-h" "C-c")
