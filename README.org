...
#+BEGIN_SRC emacs-lisp
  ...
  (let ((hashed-host (init/hashed-host-slug)))
    (message (concat "init/hashed-host-slug=" hashed-host))
    (when (equal hashed-host "24e0c4b6b602908fd5cc6be519f8d96b")
      (progn
        (when window-system (set-frame-size (selected-frame) 120 84))))
    (when (equal hashed-host "01328afcdda70c813d331f8e838aa392")
      (progn
